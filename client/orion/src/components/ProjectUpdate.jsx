...
export default function ProjectUpdate() {
    ...
    // NEW OCT24
    const filesArr = location.state?.files[0]
    console.log(filesArr)

    const filesMegaArr = []
    filesMegaArr.push(filesArr)
    console.log(filesMegaArr)

    // START: CIF
    let fileCIFExtractor = 0
    console.log(location.state?.files[0].hasOwnProperty("fileCIF"))
    ...
    let cifTest = 0
    const handleFileCIFChange = (event) => { 
        event.preventDefault()
        setFileCIF(event.target.files)
        cifTest = event.target.files
        console.log(cifTest)

        // console.log(location.state?.files[0])
        // setFileCIF(event.target?.files)
        console.log(event.target?.files)
        // filesMegaArr.push(event.target?.files)
        // console.log(filesMegaArr)
    }
    ...
    console.log(location.state?.files[0].hasOwnProperty("fileCSF"))
    ...
    // NEW JUL22
    const handleNumeroCliente= (event) => { 
        console.log(location.state?.numeroCliente)
    ...
    // NEW JUL22
    const handleNumeroTelefono = (event) => { 
        console.log(location.state?.numeroTelefono)
    ...
    const handleGiro = (event) => { 
        console.log(location.state?.giro)
    ...
    const updateData = (event) => {
        ...
        // modif may02
        console.log("Print" + empresa, cliente, numeroCliente, razonSocial, correoPrincipal, numeroTelefono, direccion, sucursal, ubicacion, giro, 
            ...
            file, payment, extraPayment, fileCIF)
    ...
    //     formData.append("folioAceptado", folioAceptado)
    ...
    return(
        <div>
            ...
            <form className="container-newProject" onSubmit={updateData}>
                ...
                <div className="multiFieldRowThree">
                    <input type="text"required onChange={handleEmpresa} defaultValue={empresa} name="empresa"></input>
                    <input type="text"required onChange={handleClientChange} defaultValue={cliente} name="cliente"></input>
                    <input type="text"required onChange={handleNumeroCliente} defaultValue={numeroCliente} name="cliente"></input>
                </div>
                ...
                <div className="multiFieldRowThree">
                    ...
                    <input type="text"required onChange={handleNumeroTelefono} defaultValue={numeroTelefono} name="numeroTelefono"></input>
                </div>
                ...
                <div className="multiFieldRowThree">
                    ...
                    <input type="text"required onChange={handleUbicacion} defaultValue={ubicacion} name="ubicacion"></input>
                </div>
                ...
                <div>
                    <input type="text"required onChange={handleGiro} defaultValue={giro} name="giro"></input>
                </div>
                {/* CLIENTE */}
                ...
                {/* CIF */}
                {filesMegaArr.map((index) => {
                    if(location.state?.files[0].hasOwnProperty("fileCIF") === true) {
                        return(
                    ...
                    else if (location.state?.files[0].hasOwnProperty("fileCIF") === false) {
                        return(
                        <div className="labelFileAndButton">
                            <label>Cédula de Identificación Fiscal</label> 
                            {/* <input type="file" name="fileCIF" accept=".pdf" onChange={(e) => setFileCIF(e.target.files)} />  */}
                            <input type="file" name="fileCIF" accept=".pdf" onChange={handleFileCIFChange} /> 
                            {/* <button onClick={handleExtraFileSubmit} className="btnMagGlass fa-sm">+</button> */}
                        </div>
                    )}
                })}
                ...
                {/* CSF */}
                {filesMegaArr.map((index) => {
                    if(location.state?.files[0].hasOwnProperty("fileCSF") === true) {
                        return(
                        <div className="labelFileAndButton">
                    ...
                    else if (location.state?.files[0].hasOwnProperty("fileCSF") === false) {
                        return(
                        <label>Constancia de Situación Fiscal NO EXISTE</label> 
                    )}
                })}

                {/* CARTA DE CONFORMIDAD */}
                {filesMegaArr.map((index) => {
                    if(location.state?.files[0].hasOwnProperty("fileCartaConformidad") === true) {
                        return(
                        <div className="labelFileAndButton">
                    ...
                    else if (location.state?.files[0].hasOwnProperty("fileCartaConformidad") === false) {
                        return(
                        <label>Carta de Conformidad NO EXISTE</label> 
                    )}
                })}

                {/* COTIZACION */}
                {filesMegaArr.map((index) => {
                    if(location.state?.files[0].hasOwnProperty("fileCotizacion") === true) {
                        return(
                        <div className="labelFileAndButton">
                    ...
                    else if (location.state?.files[0].hasOwnProperty("fileCotizacion") === false) {
                        return(
                        <label>Cotización NO EXISTE</label> 
                    )}
                })}

                {/* FACTURA */}
                {filesMegaArr.map((index) => {
                    if(location.state?.files[0].hasOwnProperty("fileFactura") === true) {
                        return(
                        <div className="labelFileAndButton">
                            <label>Factura</label> 
                    ...
                    else if (location.state?.files[0].hasOwnProperty("fileFactura") === false) {
                        return(
                        <label>Factura NO EXISTE</label> 
                    )}
                })}

                {/* ORDEN COMPRA */}
                {filesMegaArr.map((index) => {
                    if(location.state?.files[0].hasOwnProperty("fileOrdenCompra") === true) {
                        return(
                        <div className="labelFileAndButton">
                    ...
                    else if (location.state?.files[0].hasOwnProperty("fileOrdenCompra") === false) {
                        return(
                        <label>Orden de Compra NO EXISTE</label> 
                    )}
                })}

                {/* OTRO */}
                {filesMegaArr.map((index) => {
                    if(location.state?.files[0].hasOwnProperty("fileOtro") === true) {
                        return(
                        <div className="labelFileAndButton">
                            <label>Otros</label> 
                    ...
                    else if (location.state?.files[0].hasOwnProperty("fileOtro") === false) {
                        return(
                        <label>Otros NO EXISTE</label> 
                    )}
                })}

                {/* <button className="btnSubmitProject" type="submit" onClick={handleNewFileSubmit}>Agregar</button> */}

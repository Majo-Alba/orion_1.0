...
import { faEnvelope, faLocationDot, faPhone, faTag, faTrash, faHelmetSafety, faCheck, faClock, faBan } from "@fortawesome/free-solid-svg-icons"
...
function ClientsMain() {
    ...
    projects.forEach(project => {
        if(project.empresa === location.state?.empresa) {
            companyProjectsArr.push(project)
            console.log(companyProjectsArr)
        }
    })

    companyProjectsArr.forEach(project => {
        console.log(project)

        if(project.condicion === "Terminado") {
            finishedTot.push(project.total)
            console.log(finishedTot)
            ...
            console.log(sumFinished.toLocaleString());
        }
        else if(project.condicion === "Activo") {
            ...
            console.log(sumCancelled.toLocaleString());
        }
    })
    ...
    return (
        <div>
            ...
            <div className="mainSubHeader">
                <h1 className="mainSubHeaderTitle-ClientsPanel">Panel de Clientes</h1> 
            </div>
            {/* new oct09 */}
            {/* ASLEEP SEP12 */}
            <div className="mainPageGraph">
                <div className="individualGraph">
                    <FontAwesomeIcon className="iconClientHeader-Activo" icon={faHelmetSafety}/>
                ...
                <div className="individualGraph">
                    <FontAwesomeIcon className="iconClientHeader-Terminado" icon={faCheck}/>
                    <div className="graphInfo">
                ...
                <div className="individualGraph">
                    <FontAwesomeIcon className="iconClientHeader-Sleeping" icon={faClock}/>
                    <div className="graphInfo">
                ...
                <div className="individualGraphLast">
                    <FontAwesomeIcon className="iconClientHeader-Cancelled" icon={faBan}/>
                    <div className="graphInfo">
                            ...
                            <div className="previewHeader">
                                ...
                                {/* <div>
                                    <div className="totalsBlock">
                                        <label className="previewIncomes">Ingresos Generados: ${sumFinished.toLocaleString()}</label>
                                        <label className="previewIncomes">Ingresos Activos: ${sumActive.toLocaleString()} </label>
                                    </div>
                                    <div className="totalsBlock">
                                        <label className="previewIncomes">Ingresos Dormidos: ${sumSleeping.toLocaleString()} </label>
                                        <label className="previewIncomes">Ingresos Cancelados: ${sumCancelled.toLocaleString()} </label>
                                    </div>
                                </div> */}
                            </div>
